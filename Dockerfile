...
for tag in [
    ...
    '<script src="/fantasy_ovr.js?v=20260909"></script>',
]:
    s = s.replace(tag, '')
assets = '''<script>window.norm=window.norm||function(v){return String(v??'').toUpperCase()};</script><script src="/fixes.js?v=20260903"></script><script src="/fantasy_ovr.js?v=20260909"></script>'''
if assets not in s:
